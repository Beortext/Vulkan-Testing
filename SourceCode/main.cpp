...
{
    GLSL, HLSL, SpirV, // Can be used as input or output.
    //ESSL, MSL, DXIL,// Just can be used as output.
};
...
std::vector<uint32_t> glslangSpirvCompiler(std::string shaderCode, ShaderLanguage inputLanguage, ShaderStage inputStage)
{
...
private:
    ...
    inline std::string readStringShader(std::string file_path)
    {
